...
public class CPStreamTokenizer
{
  ...
  /** A comment, either //-style or /*-style. */
  ...
  private static final int TT_NONE = -6;
   ...
   */
  public CPStreamTokenizer(InputStream is)
  {
   ...
   */
  public CPStreamTokenizer(Reader r)
  {
...
//				ch = in.read();
//				if (ch == '\n') {
//					tokbuf.append((char)ch);		// but no new line number
//				} else if (ch != TT_EOF) in.unread(ch);
//			}
			ch = in.read();
		} while (isWhitespace(ch));
		if (ch != TT_EOF) in.unread(ch);
		sval = tokbuf.toString();
//System.out.println("Whitespace: '" + sval + "'");
...
//					}
  ...
  public String toString()
  {
    ...
    if (ttype == TT_EOF)
      ...
      tempstr = "n=" + nval;
	else if (ttype == TT_COMMENT)
		tempstr = sval;
	else if (ttype == TT_WHITESPACE)
		tempstr = sval;
